...
class CreatePass extends Command {
    ...
    async run(message: Message, args: Array<string>) {
        ...
        var filter = (m: any) => m.content == "Да" || m.content == "Нет" && m.author.id == isDone.get(m.guild?.id) && isNaN(m.content) && m.content.length > 0;
        ...
        var filter1 = (m: any) => m.author.id == isDone.get(m.guild?.id) && isNaN(m.content) && m.content.length > 0;
        ...
        var filter2 = (m: any) => m.content == "Да" || m.content == "Нет" && m.author.id == isDone.get(m.guild?.id) && isNaN(m.content) && m.content.length > 0;
        ...
        var filter3 = (m: any) => m.author.id == isDone.get(m.guild?.id) && isNaN(m.content) && m.content.length > 0;
        ...
        var filter4 = (m: any) => m.content == "Да" || m.content == "Нет" && m.author.id == isDone.get(m.guild?.id) && isNaN(m.content) && m.content.length > 0;
        ...
        var filter5 = (m: any) => m.content == "М" || m.content == "Ж" && m.author.id == isDone.get(m.guild?.id) && isNaN(m.content) && m.content.length > 0;
        ...
        var filter6 = (m: any) => m.author.id == isDone.get(m.guild?.id) && !isNaN(m.content) && parseInt(m.content) <= 60 && parseInt(m.content) > 17;
        ...
        var filter7 = (m: any) => m.author.id == isDone.get(m.guild?.id) && isNaN(m.content) && m.content.length > 150 && m.content.length > 0 && m.content.length < 1024;
        ...
        var filter8 = (m: any) => m.author.id == isDone.get(m.guild?.id) && m.content.length <= 5 && m.content.length > 0 && m.content.includes("/");
        ...
        var filter9 = (m: any) => m.author.id == isDone.get(m.guild?.id) && isImageUrl(m.content);
        ...
        var filter10 = (m: any) => m.content == "Да" || m.content == "Нет" && m.author.id == isDone.get(m.guild?.id) && isNaN(m.content) && m.content.length > 0;
