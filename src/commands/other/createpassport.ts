...
class CreatePass extends Command {
    constructor(){
        super({
            name: "createpass",
            description: "Данная команда создает Ваш паспорт, он нужен для того что бы начать игру в мини-РПГ и иметь доступ к банку, заработку денег, работам и многим многм другим функциям!",
            aliases: ["cp"],
            category: "other",
            usage: ">createpass"
        });
